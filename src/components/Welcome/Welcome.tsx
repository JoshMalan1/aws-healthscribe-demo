    ...
    function Footer() {
        return (
            <Box textAlign="center" color="text-body-secondary" fontSize="body-s">
                <p>Copyright ExperityHealth.com, All Rights Reserved.</p>
            </Box>
        );
    }

    return (
        <ContentLayout header={<Header variant="h2">Experity Demo Application powered by AWS HealthScribe</Header>}>
